        ...
        <div class="intro">
            ...
            ?>
                ...
                <div class="typewriter">
                    <p class="line1">Profesional dedicado a la creación de páginas web</p>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title">Vídeo Presentación</h4>
                                </div>
                        ...
                        <div class="portfolio-item col-xs-4 col-sm-2 col-md-2" data-groups='["<?php echo $dato['categoria']; ?>","todos"]'>
                            <div class="portfolio-bg">
                                <div class="portfolio">
                                    ...
                                    <img src="assets/images/works/<?php echo $dato['foto']; ?>" alt="<?php echo $dato['titulo']; ?>">
                            ...
                            <div class=portfolio-bg>
                                <div class=portfolio>
                                    ...
                                    <div class="links links-w"> <a href=https://coplasem.com/ target="_blank"><i class="fa fa-link"></i></a> <a href=#coplasem class=open-popup-link><i class="fa fa-list"></i></a>
                                        <div id=coplasem class="white-popup mfp-hide">Proyecto 360 de Ecommerce basado en PrestaShop para empresa de venta de material para embalaje. Theme modificado, módulos personalizados, conexión con ERP, etc...</div>
                                    </div>
                ...
                <div class="col-md-6">
                    <div class="contact-form">
                        ...
                        <form name="contact-form" id="contact-form" method="post" action="assets/php/sendemail.php">
                            ...
                            <div class="form-group">
                                <label for="numero">Resuelve la operación <?php echo $_SESSION["num1"]; ?> + <?php echo $_SESSION["num2"]; ?>:</label>
